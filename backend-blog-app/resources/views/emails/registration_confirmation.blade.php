						...
						<div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
							<div class="u-col u-col-100"
								...
								<div style="width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
									<div style="padding: 10px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; text-align: center">
										<img align="center" border="0" src="{{ asset('logo.png') }}" alt="Logo" title="Logo"
											style="outline: none;" width="255.2" class="v-src-width v-src-max-width"/>
									</div>
								</div>
							</div>
						</div>
													...
													<table width="100%" cellpadding="0" cellspacing="0" border="0">
														<tr>
															<td style="padding-right: 0px;padding-left: 0px;" align="center">
																...
																<div style="width: 90%; line-height: 20px;">
																	<h1 class="v-font-size"
																		style="line-height: 160%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 33px;">
																		<strong>Approve Now</strong>
																	</h1>
																	...
																	<div style="color: #444444; line-height: 170%; text-align: left; word-wrap: break-word;">
																		<p style="font-size: 14px; line-height: 170%;">
																			<span style="font-size: 16px; line-height: 27.2px;">
																				Dear {{$user['name']}}, <br>
																				You are successfully registered for Monster Gear. Please click the verify button bellow to complete your registration. 
																			</span>
																		</p>
																	</div>

																	<a href="{{$user['shop_domain'].'verification/'.$user['token']}}" target="_blank" style="margin: 20px 0px; display: inline-block; color: #FFFFFF; background-color: #cca250;">
																		<span style="display:block;padding:14px 33px;line-height:120%;">
																			<strong><span style="font-size: 16px; line-height: 19.2px;">Click Here &rarr;</span></strong>
																		</span>
																	</a>
																	...
																	<div style="color: #444444; line-height: 170%; text-align: left; word-wrap: break-word;">
																		<p style="font-size: 14px; line-height: 170%;">
																			<span style="font-size: 16px; line-height: 27.2px;">
																				If the above link does not work for you, please copy and paste the following link into your browser address bar: 
																			</span>
																			<br>
																			<a href="{{$user['shop_domain'].'verification/'.$user['token']}}" target="_blank">
																				{{$user['shop_domain'].'verification/'.$user['token']}}
																			</a>
																		</p>
																	</div>

																	<div style="margin: 20px 0px; color: #444444; line-height: 170%; text-align: left; word-wrap: break-word;">
																		<p style="font-size: 14px; line-height: 170%;">
																			<span style="font-size: 16px; line-height: 27.2px;">
												...
												<td class="v-container-padding-padding"
													...
													<div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
														<p style="font-size: 14px; line-height: 140%;"><span
																style="font-size: 18px; line-height: 25.2px;"><strong>Monster Gear</strong></span>
														</p>
													</div>
											...
											<tr>
												<td class="v-container-padding-padding"
													...
													<div style="color: #b0b1b4; line-height: 180%; text-align: center; word-wrap: break-word;">
														<p style="font-size: 14px; line-height: 180%;">123 San Francisco,
															CA. United States</p>
										...
										<table style="font-family:'Montserrat',sans-serif;" role="presentation"
											...
											<tr>
												<td class="v-container-padding-padding"
													...
													<div style="color: #b0b1b4; line-height: 180%; text-align: center; word-wrap: break-word;">
														<p style="font-size: 14px; line-height: 180%;">&copy; 20XX All
															Rights Reserved</p>
													</div>
